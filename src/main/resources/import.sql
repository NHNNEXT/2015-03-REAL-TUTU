insert into user(user_id, email, introduce, major, name, password, profile_url, state) values (1, 'test1@test.com', null, null, '\uad501', '$2a$10$9cbnbv55q2xuwkjrjkj/q.ovkslkceyz9.w.wjx42xo/e42ncoic.', null, null), (2, 'test2@test.com', null, null, '\ud5592', '$2a$10$goiascg/lgg.f48syxmogugdcyydym1zqdndi3pktc7jk.i8llgse', null, null);

insert into lecture(lecture_id, major_type, name, register_policy, host_user_id) values (1, 1, '\uc790\ub8cc\uad6c\uc870', 1, 1);
...
insert into user_group(id, default_group, name, lecture_id) values(1, false, '\uc870\uad50', 1),(2, true, '\uc218\uac15\uc0dd', 1);

insert into content_type(id, end_time, extend_write, name, only_writer, start_time, statistic, lecture_id) values(1, true, true, '\uc218\uc5c5', null, true, null, 1),(2, null, null, '\uac15\uc758\uc790\ub8cc', null, null, null, 1),(3, null, null, '\uc9c8\ubb38', null, null, null, 1),(4, true, null, '\uacfc\uc81c', true, null, true, 1);
...
insert into reply(reply_id, body, write_date, content_id, writer_id) values(1, '\ud6c4\ud6d7', timestamp '2015-11-19 15:27:06.497', 5, 1);
