...
insert into lecture (lecture_id,  major_type, name, host_user_id, register_policy_type) values (null, 0, 'jagual',  1, 1);
insert into lecture (lecture_id,  major_type, name, host_user_id, register_policy_type) values (null, 1, 'network',  2, 0);
insert into lecture (lecture_id,  major_type, name, host_user_id, register_policy_type) values (null, 2, 'real',  3, 1);
insert into lecture (lecture_id,  major_type, name, host_user_id, register_policy_type) values (null, 0, 'abcd',  3, 0);
