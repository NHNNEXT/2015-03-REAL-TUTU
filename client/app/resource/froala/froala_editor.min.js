...
!function (a) {
  ...
  a.FroalaEditor.NO_DELETE_TAGS = ["TH", "TD", "TABLE"], a.FroalaEditor.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI"], a.FroalaEditor.MODULES.cursor = function (b) {
    ...
    function i(c) {
      ...
      if (b.node.isBlock(d)) {
        ...
        if (d.nodeType == Node.TEXT_NODE) {
          ...
          a(d).after(a.FroalaEditor.MARKERS), d.textContent = d.textContent.substring(0, d.length - 1), d.textContent.length && 55357 == d.textContent.charCodeAt(d.textContent.length - 1) && (d.textContent = d.textContent.substr(0, d.textContent.length - 1))
    ...
    function m() {
      ...
      a(e).remove(), b.$el.find("blockquote:empty").remove(),
        b.html.fillEmptyBlocks(!0), b.html.cleanEmptyTags(!0), b.clean.quotes(), b.clean.lists(), b.html.normalizeSpaces(), b.selection.restore()
    }
    ...
    function e() {
      ...
      try {
        ...
        if (e.insertNode(f), f = b.$el.find("span.fr-marker").get(0)) {
          for (var g = f.nextSibling; g && g.nodeType === Node.TEXT_NODE && 0 === g.textContent.length;)a(g).remove(), g = b.$el.find("span.fr-marker").get(0).nextSibling;
          return f
        }
        return null
      } catch (h) {
  ...
  a.FroalaEditor.ENTER_P = 0, a.FroalaEditor.ENTER_DIV = 1, a.FroalaEditor.ENTER_BR = 2, a.FroalaEditor.KEYCODE = {
    ...
    function o(c) {
      ...
      !c || c.which != a.FroalaEditor.KEYCODE.ENTER && c.which != a.FroalaEditor.KEYCODE.BACKSPACE || n();
    ...
    var v, w, x = !1;
    return {require: ["core", "cursor", "events"], _init: u, ctrlKey: p, isCharacter: q, forceUndo: t}
  }
}(jQuery), function (a) {
  "use strict";
  ...
  a.extend(a.FroalaEditor.DEFAULTS, {
    ...
    return {require: ["events"], _init: g, show: c, hide: d, refresh: f, isVisible: e}
  }
}(jQuery), function (a) {
  "use strict";
  a.extend(a.FroalaEditor.DEFAULTS, {
  ...
  a.FroalaEditor.MODULES.button = function (b) {
    function c(c) {
      ...
      if (b.helpers.isIOS() && 0 == b.$el.find(".fr-marker").length && (b.selection.save(), b.selection.clear(), b.selection.restore()), !f) {
        var h = d.data("cmd");
        e.find(".fr-command").removeClass("fr-active"), a.FroalaEditor.COMMANDS[h] && a.FroalaEditor.COMMANDS[h].refreshOnShow && a.FroalaEditor.COMMANDS[h].refreshOnShow.apply(b, [d, e]),
          e.css("left", d.offset().left - d.parent().offset().left - ("rtl" == b.opts.direction ? e.width() - d.outerWidth() : 0)), b.opts.toolbarBottom ? e.css("bottom", b.$tb.height() - d.position().top) : e.css("top", d.position().top + d.outerHeight())
      }
  ...
  a.FroalaEditor.MODULES.position = function (b) {
    ...
    function i(c) {
      if (c.offsetWidth) {
        var d, e, f = a(c), g = f.outerHeight(), h = f.data("sticky-offset"), i = f.data("sticky-position"), j = a("body" == b.opts.scrollableContainer ? b.original_window : b.opts.scrollableContainer).scrollTop(), k = a("body" == b.opts.scrollableContainer ? b.original_window : b.opts.scrollableContainer).outerHeight(), l = 0, m = 0;
        "body" !== b.opts.scrollableContainer && (l = a(b.opts.scrollableContainer).offset().top, m = a(b.original_window).outerHeight() - l - k);
        var n = f.is(".fr-sticky-on"), o = f.parent(), p = o.offset().top, q = o.outerHeight();
        if (!i) {
          var r = "auto" !== f.css("top") || "auto" !== f.css("bottom");
          r || f.css("position", "fixed"), i = {
            top: "auto" !== f.css("top"),
            bottom: "auto" !== f.css("bottom")
          }, r || f.css("position", ""), f.data("sticky-position", i), f.data("top", f.css("top")), f.data("bottom", f.css("bottom"))
        }
        ...
        var s, t = function () {
          return s = ("body" != b.opts.scrollableContainer ? l : j) + d, s > h && p + q >= s + g
        }, u = function () {
          return s = ("body" != b.opts.scrollableContainer ? l : j) - e, h + (g || 0) > s + k && s + k >= p + g
        };
        d = b.helpers.getPX(f.data("top")), e = b.helpers.getPX(f.data("bottom"));
        var v = i.top && t(), w = i.bottom && u();
        v || w ? (f.css("width", o.width() + "px"), n || (f.addClass("fr-sticky-on"), f.removeClass("fr-sticky-off"), f.css("top") && ("auto" != f.data("top") ? f.css("top", b.helpers.getPX(f.data("top")) + l) : f.data("top", "auto")), f.css("bottom") && ("auto" != f.data("bottom") ? f.css("bottom", b.helpers.getPX(f.data("bottom")) + m) : f.css("bottom", "auto")))) : f.hasClass("fr-sticky-off") || (f.width(""), f.removeClass("fr-sticky-on"), f.addClass("fr-sticky-off"), f.css("top") && f.css("top", 0), f.css("bottom") && f.css("bottom", 0))
      }
    }
    ...
    function k() {
      if (!j())if (b._stickyElements = [], b.helpers.isIOS()) {
        ...
        a("body" == b.opts.scrollableContainer ? b.original_window : b.opts.scrollableContainer).on("scroll.sticky" + b.id, d), a(b.original_window).on("resize.sticky" + b.id, d), b.events.on("initialized", d), b.events.on("focus", d), a(b.original_window).on("resize", "textarea", m)
      }
    }
